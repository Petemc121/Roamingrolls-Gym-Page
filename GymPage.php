...
<button type="button" id="minInstructor" class="plusevent"><i class="fas fa-minus-circle fa-lg"></i></button>
...
var inMinus = document.getElementById('minInstructor');
